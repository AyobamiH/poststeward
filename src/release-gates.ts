...
export const releaseGateDefinitions: readonly ReleaseGateDefinition[] = [
  ...
  },
  {
    ...
    scope: "provider_optional",
    blocking: false,
    summary: "X offline refresh authority and refresh capability are present, but a real token-expiry refresh rotation has not been deliberately exercised.",
    evidence: ["docs/x-oauth-publication-live-evidence-2026-09-20.md"],
    ownerAction: "Observe one safe refresh rotation after natural expiry or through a controlled non-publishing drill.",
  },
  {
