...
export const releaseGateDefinitions: readonly ReleaseGateDefinition[] = [
  ...
  },
  {
    ...
    blocking: false,
    summary: "X application/client authority is configured in staging and production; the real owner OAuth grant, stable identity, refresh lifecycle and active connection remain unaccepted.",
    evidence: ["docs/live-external-gates-2026-09-13.md", "docs/provider-connection-audit-2026-09-19.md"],
  },
  {
