...
**Restricted staging is deployed.** The [9 September deployment receipt](staging-deployment-2026-09-09.md) records the successful historical run, exact runtime revision, Cloudflare version and the 17 hosted checks that existed at that deployment. D1 access and required owner/encryption settings are configured. PR #20 is deployed at `e48a1e7ef9ed6388f8c5934aae5426fe40a0ed6c`; its [10 September receipt](private-github-staging-2026-09-10.md) records migration 0009 and all 25 base hosted surfaces plus owner/browser/recovery/lifecycle checks. Live readiness reports private GitHub sources and X/Threads/LinkedIn OAuth unconfigured; real owner/provider/private-source acceptance remains outstanding. Do not recreate existing staging resources, regenerate its encryption key or repeat credential entry. The setup procedure below remains relevant for a new environment and eventual production. Do not paste secrets into chat, issues, source files or workflow inputs.
